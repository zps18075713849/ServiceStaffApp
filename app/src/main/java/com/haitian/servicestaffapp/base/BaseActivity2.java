...
//    }
    ...
    //补贴金提示
    @SuppressLint("ResourceAsColor")
    public void showAffirmDialog4(String title, String leftTv, String message, View.OnClickListener
            onClickListener) {
        new CircleDialog.Builder(this)
                .setTitle(title)
                .setText(message)//内容
                .setTextColor(R.color.text_color)//内容字体色值
                .setNegative(leftTv, null)
                .setWidth(0.7f)
                .setMaxHeight(0.4f)
                .show();
    }
    ...
    public void showAffirmDialog5(String title, String message, View.OnClickListener
        ...
        new CircleDialog.Builder(this)
                .setTitle(title)
                .setText(message)//内容
                .setTextColor(R.color.black)//内容字体色值
                .setNegative("去登录", null)
                .setWidth(0.7f)
                .setMaxHeight(0.4f)
                .show();
    }
    ...
    @SuppressLint("ResourceAsColor")
    public void showAffirmDialogRegister(String title, String message, View.OnClickListener
            onClickListener) {
        new CircleDialog.Builder(this)
                .setTitle(title)
                .setText(message)//内容
    ...
    //脑电登录需要完善信息， 强制弹窗
    @SuppressLint("ResourceAsColor")
    public void showNDWanShanMessage(String title, String rightTv, String message, View.OnClickListener
            onClickListener) {
        new CircleDialog.Builder(this)
                .setTitle(title)
                .setText(message)//内容
                .setTextColor(R.color.text_color)//内容字体色值
                .setPositive(rightTv, onClickListener)
                .setWidth(0.7f)
                .setMaxHeight(0.4f)
                .setCancelable(false)
                .show();
...
//                                                    responseMessage) {
//                                                if (responseCode == 0) {
//                                                    Intent intent = new Intent(BaseActivity2.this,
...
//                    }
//                };
//                dialog2 = DialogCreator.createLogoutStatusDialog(BaseActivity2.this,
...
//                LogUtil.e("-----------重新登录---------000111----000----");
//                Intent intent = new Intent(BaseActivity2.this, LoginActivity.class);
//                startActivity(intent);
//                LogUtil.e("-----------重新登录+++++++++++000111---1111----");
//                break;
//        }
//    }
