...
public class DoctorNetService {
    //已完成工单
    public static void requestYiWanChanggongdan(final String url, final Map<String, Object> param, final
    NetWorkRequestInterface requestInterface) {
        Observable.create(new Observable.OnSubscribe<Object>() {
            ...
            public void call(Subscriber<? super Object> subscriber) {
                ...
                YiwanchangGongDanBean infoBean = gson.fromJson(result, YiwanchangGongDanBean.class);
                if(result!=null){
