...
public class JiFen_Activity extends BaseActivity {
    ...
    protected int provideLayoutId() {
        return R.layout.activity_ji_fen_;
    }
    ...
    protected void initViews() {
        ...
        mTab_id.addTab(mTab_id.newTab().setText("赚积分"));
        mTab_id.addTab(mTab_id.newTab().setText("我的积分"));
        mTab_id.addTab(mTab_id.newTab().setText("积分明细"));
    }
