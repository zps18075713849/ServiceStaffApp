...
public class WindowUtils {
    ...
    private static View setUpView(final Context context) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.quanjudialog,
                null);
        TextView positiveBtn = (TextView) view.findViewById(R.id.submit);
        ...
        TextView negativeBtn = (TextView) view.findViewById(R.id.cancel);
        ...
        // 所以点击内容区域外部视为点击悬浮窗外部
        final View popupWindowView = view.findViewById(R.id.popup);// 非透明的内容区域
