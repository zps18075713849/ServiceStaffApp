...
import com.haitian.servicestaffapp.utils.Bezier;
import com.haitian.servicestaffapp.utils.ControlTimedPoints;
import com.haitian.servicestaffapp.utils.TimedPoint;
...
//		mPaint.setTextSize(100);             //绘制文字大小，单位px
	...
	/**
	 * Called when replaying history to ensure the dirty region includes alldoctor_fragment
	 * mPoints.
	 *
	 * @param historicalX
