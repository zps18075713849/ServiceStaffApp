...
public class CalendarGridViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        itemLayout.setBackgroundResource(R.drawable.yuan_calend);
...
//        textDay.setBackgroundResource(R.drawable.yuan_calend);
        textDay.setPadding(10,10,10,10);
//        textDay.setHeight(40);
...
//                    textDay.setTextColor(Color.parseColor("#767676"));
                }
            }
